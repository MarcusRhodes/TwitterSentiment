...
#dataset_path = "/home/marcus/Documents/CS450/TwitterSentiment/data/training.1600000.processed.noemoticon.csv"
dataset_path = "data/training.1600000.processed.noemoticon.csv"

print("Open file:", dataset_path)
df = pd.read_csv(dataset_path, encoding=DATASET_ENCODING , names=DATASET_COLUMNS)
#df = pd.read_csv(dataset_path, sep = ',', header=0, skipinitialspace=True, na_values=["?"])
#pd.read_csv("data/ramen-ratings.csv", sep = ',', header=0, skipinitialspace=True, na_values=["?"])
...
def buildTestSet(search_keyword):
    try:
        ...
        return [{"text":status.text, "label":predict(status.text)} for status in tweets_fetched]
    except:
